...
namespace Go81WebApp.ModuleTester
{
    public partial class MainWindow
    {
        ...
        {
            List<long> idlist = new List<long> { 10001,10003,20306, 10004, 10005, 10007, 10008, 10009, 10011, 10012, 10013, 10014, 10015, 20057, 20151, 20150, 20145, 20146, 20137, 20138, 20139, 20140, 20141, 20142, 20143, 20144, 20152, 20149, 20147, 20148, 20261, 20292, 20254 };
        ...
        private void Button_Click8(object sender, RoutedEventArgs e)
        {
            ...
            //var ghys = 用户管理.查询用户<供应商>(0, 0);
            //var sdf = "";
            //foreach (var item in ghys)
            //{
            //    sdf += item.企业基本信息.所属行业 + "\n";
            //}
            //textBox1.Text = sdf;
            MessageBox.Show("OK");
        }
