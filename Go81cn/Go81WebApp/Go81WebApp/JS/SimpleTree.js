	...
	$.fn.extend({
		SimpleTree:function(options){
			...
			this.find("a").click(function () {
			    if ($(this).attr("href") == "#")
			    {
			        $(this).parents("li").click(); return false;
			    }
			});
			...
			this.find("li").click(function () {
				...
				if ($(this).next("ul").attr("show") == "true") {
				    ...
				    $(this).next("ul[show='true']").slideDown(200);	/* 显示 show 属性为 true 的子级菜单 */                                                     
				    $(this).next("ul[show='true']").prev("li").addClass("open");	/* 添加 show 属性为 true 的子级菜单父节点的 open 样式 */
