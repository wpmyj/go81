...
namespace Go81WebApp.Models.数据模型.项目数据模型
{
    public class 验收单 : 基本数据模型
    {
        ...
        public string 管理单位审核人签名 { get; set; }
        ...
        public class _物资或服务条目
        {
            ...
            public decimal 总价 { get { return decimal.Multiply(Convert.ToDecimal(this.数量), this.单价); } }
    ...
    public static class 验收单单位列表信息
    {
        ...
        {
            new 验收单单位信息 {Id = 20351, 验收单名称 = "成都军区联勤部军需物资油料部", 验收单审核单位名称 = "成都军区联勤部军需物资油料部(中标商品类)", 印章底部文本 = "物资采购专用章",签名图片链接="/Images/seal/采购处签名1.png",盖章图片链接 = ""},//原来是10001
            new 验收单单位信息 {Id = 10003, 验收单名称 = "成都军区联勤部军需物资油料部", 验收单审核单位名称 = "成都军区联勤部军需物资油料部(办公物资类)", 印章底部文本 = "物资采购专用章",签名图片链接="/Images/seal/采购处签名.png",盖章图片链接 = ""},
            ...
            new 验收单单位信息 {Id = 10007, 验收单名称 = "成都总医院物资采购中心", 验收单审核单位名称 = "成都总医院物资采购中心", 印章底部文本 = "物资采购专用章",签名图片链接="/Images/seal/成都军区总医院签名0.png",盖章图片链接 = ""},
           ...
           new 验收单单位信息 {Id = 20321, 验收单名称 = "中国人民解放军贵州省清镇市人武部", 验收单审核单位名称 = "中国人民解放军贵州省清镇市人武部", 印章底部文本 = "",签名图片链接="/Images/seal/贵州省清镇市人武部签名.png",盖章图片链接 = "/Images/seal/贵州省清镇市人武部章.png"},
           new 验收单单位信息 {Id = 20089, 验收单名称 = "中国人民解放军四川陆军预高师", 验收单审核单位名称 = "中国人民解放军四川陆军预高师", 印章底部文本 = "物资采购专用章",签名图片链接="/Images/seal/四川预高师签名.png",盖章图片链接 = "/Images/seal/四川预高师印章.png"},
