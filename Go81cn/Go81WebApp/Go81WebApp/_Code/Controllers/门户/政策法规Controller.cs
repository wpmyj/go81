...
{
    public class 政策法规Controller : Controller
    {
        private static int PAGESIZE = int.Parse(ConfigurationManager.AppSettings["政策法规每页显示条数"]);

        [静态化]
        public ActionResult ZcfgList()
        {
            return View();
        }
        public ActionResult ZcfgDetail()
        {
            return View();
        }
        public ActionResult Part_ZcfgList()
        {
            int listcount = (int)(政策法规管理.计数政策法规(0, 0,Query<政策法规>.EQ(o=>o.审核数据.审核状态, 审核状态.审核通过), includeDisabled:false));
            ...
            //政策法规列表
            ViewData["政策法规列表"] = 政策法规管理.查询政策法规(0, PAGESIZE, Query<政策法规>.EQ(o => o.审核数据.审核状态, 审核状态.审核通过), false, SortBy.Descending("内容主体.发布时间"), false);
            return PartialView("Part_Zcfg/Part_ZcfgList");
        }
        ...
        public ActionResult Part_SearchByPage()
        {
            ...
            //政策法规列表
            ViewData["政策法规列表"] = 政策法规管理.查询政策法规(PAGESIZE * (page - 1), PAGESIZE, Query<政策法规>.EQ(o => o.审核数据.审核状态, 审核状态.审核通过), false, SortBy.Descending("内容主体.发布时间"), false);
            return PartialView("Part_Zcfg/Part_SearchByPage");
        }

        public ActionResult Part_ZcfgDetail()
        {
            政策法规 model = null;
            try
            {
                model = 政策法规管理.查找政策法规(int.Parse(Request.QueryString["id"]));
            }
            catch
            {
            ...
            return PartialView("Part_Zcfg/Part_ZcfgDetail", model);
        }
        public ActionResult Part_OtherList()
        {
            ViewData["政策法规"] = 政策法规管理.查询政策法规(0, 10, Query<政策法规>.EQ(o => o.审核数据.审核状态, 审核状态.审核通过), false, SortBy.Descending("内容主体.发布时间"), false);
            return PartialView("Part_Zcfg/Part_OtherList");
        }

        public ActionResult ZcfgSearch()
        {
            return View();
        }

        [HttpPost]
        public ActionResult ZcfgListSearch()
        {
            return View("ZcfgSearch");
        }
        ...
        public ActionResult Part_SearchByCondition()
        {
            ...
            TopDocs serchalllist = SearchIndex("/Lucene.Net/IndexDic/Zcfg", keyword);
            ...
            return PartialView("Part_Zcfg/Part_SearchByCondition");
        }
        /// <summary>
        /// 从索引搜索结果
        /// </summary>
